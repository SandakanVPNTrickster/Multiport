...
# https://raw.githubusercontent.com/SandakanVPNTrickster/Multiport/main/main/allow 
...
if [ "" = "$PKG_OK" ]; then
  ...
  echo ""
  sleep 1
  echo -e "[ ${tyblue}NOTES${NC} ] 1. Buy Coffee"
  sleep 1
  echo ""
  sleep 1
  echo -e "[ ${tyblue}NOTES${NC} ] After Finished"
  sleep 1
...
sleep 2
clear
wget https://raw.githubusercontent.com/SandakanVPNTrickster/Multiport/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
