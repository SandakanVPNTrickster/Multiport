...
echo -e "         OWNER : ${GREEN}SandakanVPNTrickster ${NC}${YELLOW}(${NC} ${GREEN}SquidVPN ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By SandakanVPNTrickster ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
